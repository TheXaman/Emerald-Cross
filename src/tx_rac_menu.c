...
enum
{
    MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE,
    MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE,
    MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE,
    MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING,
    MENUITEM_CHALLENGES_NUZLOCKE_DELETION,
...
} static const sItemFunctionsRandom[MENUITEM_RANDOM_COUNT] =
{
    ...
    [MENUITEM_RANDOM_POKEMON_TIERS] = {DrawChoices_Random_EvoStages,          ProcessInput_Options_Two},
...
{
    [MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE]         = {DrawChoices_Challenges_Nuzlocke,     ProcessInput_Options_Three},
    [MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE]   = {DrawChoices_Nuzlocke_SpeciesClause,  ProcessInput_Options_Two},
    [MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE]     = {DrawChoices_Nuzlocke_ShinyClause,    ProcessInput_Options_Two},
    [MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING]       = {DrawChoices_Nuzlocke_Nicknaming,     ProcessInput_Options_Two},
    [MENUITEM_CHALLENGES_NUZLOCKE_DELETION]         = {DrawChoices_Nuzlocke_Deletion,       ProcessInput_Options_Two},
...
static const u8 sText_SimiliarEvolutionLevel[] =    _("POKéMON TIERS");
...
static const u8 *const sOptionMenuItemsNamesRandom[MENUITEM_RANDOM_COUNT] =
{
    ...
    [MENUITEM_RANDOM_POKEMON_TIERS]   = sText_SimiliarEvolutionLevel,
...
{
    [MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE]        = sText_Nuzlocke,
    [MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE]  = sText_SpeciesClause,
    [MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE]    = sText_ShinyClause,
    [MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING]      = sText_Nicknaming,
    [MENUITEM_CHALLENGES_NUZLOCKE_DELETION]        = sText_Deletion,
...
static bool8 CheckConditions(int selection)
{
    ...
    case MENU_RANDOMIZER:
        switch(selection)
        {
            case MENUITEM_RANDOM_WILD_PKMN:                 return TRUE;
            case MENUITEM_RANDOM_TRAINER:                   return TRUE;
            case MENUITEM_RANDOM_STATIC:                    return TRUE;
            case MENUITEM_RANDOM_POKEMON_TIERS:   return (sOptions->sel_randomizer[MENUITEM_RANDOM_WILD_PKMN] 
            ...
            case MENUITEM_RANDOM_INCLUDE_LEGENDARIES:       return (sOptions->sel_randomizer[MENUITEM_RANDOM_WILD_PKMN] 
                                                                    || sOptions->sel_randomizer[MENUITEM_RANDOM_TRAINER]
                                                                    || sOptions->sel_randomizer[MENUITEM_RANDOM_STATIC]);
            case MENUITEM_RANDOM_TYPE:                      return TRUE;
            case MENUITEM_RANDOM_MOVES:                     return TRUE;
            case MENUITEM_RANDOM_ABILITIES:                 return TRUE;
            case MENUITEM_RANDOM_EVOLUTIONS:                return TRUE;
            case MENUITEM_RANDOM_EVOLUTIONS_METHODS:        return TRUE;
            case MENUITEM_RANDOM_TYPE_EFFEC:                return TRUE;
            case MENUITEM_RANDOM_ITEMS:                     return TRUE;
            case MENUITEM_RANDOM_CHAOS:                     return (sOptions->sel_randomizer[MENUITEM_RANDOM_WILD_PKMN]
                                                                || sOptions->sel_randomizer[MENUITEM_RANDOM_TRAINER]
                                                                || sOptions->sel_randomizer[MENUITEM_RANDOM_STATIC]
    ...
    case MENU_CHALLENGES:
        switch(selection)
        {
        case MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE:  return sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE];
        case MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE:    return sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE];
        case MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING:      return sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE];
        case MENUITEM_CHALLENGES_NUZLOCKE_DELETION:        return sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE];
...
static const u8 sText_Description_WildPokemon_Off[]            = _("The game will have the same wild\nPOKéMON as POKéMON EMERALD.");
static const u8 sText_Description_WildPokemon_On[]             = _("Wild POKéMON will get randomized.");
static const u8 sText_Description_Random_Trainer_Off[]         = _("Trainers will have their expected\nPOKéMON parties.");
static const u8 sText_Description_Random_Trainer_On[]          = _("Randomizes enemy trainer parties.");
static const u8 sText_Description_Random_Static_Off[]          = _("Static encounters like KECLEON will\nbe the same as POKéMON EMERALD.");
static const u8 sText_Description_Random_Static_On[]           = _("Randomizes static encounters such\nas KECLEON or RAYQUAZA.");
static const u8 sText_Description_SimiliarEvolutionLevel_On[]  = _("{PKMN} replaced with similar tier ones.\nCurrently {COLOR 8}only{COLOR DARK_GRAY} based on evo stages.");
static const u8 sText_Description_SimiliarEvolutionLevel_Off[] = _("Randomization doesn't get balanced.\nA WURMPLE could replace a SCEPTILE.");
static const u8 sText_Description_IncludeLegendaries_Off[]     = _("Legendary POKéMON will be {COLOR 8}excluded{COLOR DARK_GRAY}\nfrom the randomization.");
static const u8 sText_Description_IncludeLegendaries_On[]      = _("Legendary POKéMON will be {COLOR 8}included{COLOR DARK_GRAY}\nin the randomization.");
static const u8 sText_Description_Random_Types_Off[]           = _("POKéMON types stay the same as\nPOKéMON EMERALD.");
static const u8 sText_Description_Random_Types_On[]            = _("Randomizes all POKéMON types.");
static const u8 sText_Description_Random_Moves_Off[]           = _("POKéMON moves stay the same as\nPOKéMON EMERALD.");
static const u8 sText_Description_Random_Moves_On[]            = _("Randomizes all POKéMON moves.");
static const u8 sText_Description_Random_Abilities_Off[]       = _("POKéMON abilities stay the same as\nPOKéMON EMERALD.");
static const u8 sText_Description_Random_Abilities_On[]        = _("Randomizes all POKéMON abilities.");
static const u8 sText_Description_Random_Evos_Off[]            = _("POKéMON evolutions stay the same\nas POKéMON EMERALD.");
static const u8 sText_Description_Random_Evos_On[]             = _("Randomizes all POKéMON evolutions.\nThis only changes species.");
static const u8 sText_Description_Random_Evo_Methods_Off[]     = _("Evolution methods stay the same as\nPOKéMON EMERALD.");
static const u8 sText_Description_Random_Evo_Methods_On[]      = _("Randomizes evolution methods.\nAllows new evolution chains.");
static const u8 sText_Description_Random_Effectiveness_Off[]   = _("Type effectiveness chart will remain\nthe same as POKéMON EMERALD.");
static const u8 sText_Description_Random_Effectiveness_On[]    = _("Randomizes type effectiveness.");
static const u8 sText_Description_Random_Items_Off[]           = _("All found and received ITEMs are\nthe same as POKéMON EMERALD.");
static const u8 sText_Description_Random_Items_On[]            = _("Randomizes found, hidden and gifted\nITEMs. KEY ITEMS are excluded.");
static const u8 sText_Description_Chaos_Mode_Off[]             = _("Randomization will be standard.");
static const u8 sText_Description_Chaos_Mode_On[]              = _("Every above choosen option will be\nvery chaotic. Not recommended.");
static const u8 sText_Description_Random_Next[]                = _("Continue to the DIFFICULTY page.");
...
static const u8 *const sOptionMenuItemDescriptionsRandomizer[MENUITEM_RANDOM_COUNT][2] =
{
    ...
    [MENUITEM_RANDOM_POKEMON_TIERS]   = {sText_Description_SimiliarEvolutionLevel_On,    sText_Description_SimiliarEvolutionLevel_Off},
...
{
    [MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE]            = {sText_Description_TXC_Nuzlocke_Base,             sText_Description_TXC_Nuzlocke_Normal,               sText_Description_TXC_Nuzlocke_Hard,        sText_Empty},
    [MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE]      = {sText_Description_TXC_Nuzlocke_SpeciesClause_On, sText_Description_TXC_Nuzlocke_SpeciesClause_Off,    sText_Empty,                                sText_Empty},
    [MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE]        = {sText_Description_TXC_Nuzlocke_ShinyClause_On,    sText_Description_TXC_Nuzlocke_ShinyClause_Off,     sText_Empty,                                sText_Empty},
    [MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING]          = {sText_Description_TXC_Nuzlocke_Nicknaming_On,     sText_Description_TXC_Nuzlocke_Nicknaming_Off,      sText_Empty},   
    [MENUITEM_CHALLENGES_NUZLOCKE_DELETION]            = {sText_Description_TXC_Nuzlocke_Deletion_Cemetery, sText_Description_TXC_Nuzlocke_Deletion_Deletion,   sText_Empty,                                sText_Empty},
...
static const u8 sText_TopBar_Randomizer[]   = _("{OPTION_BIG_DOT} {OPTION_SMALL_DOT} {OPTION_SMALL_DOT} RANDOMIZER");
static const u8 sText_TopBar_Difficulty[]   = _("{OPTION_SMALL_DOT} {OPTION_BIG_DOT} {OPTION_SMALL_DOT} DIFFICULTY");
static const u8 sText_TopBar_Challenges[]   = _("{OPTION_SMALL_DOT} {OPTION_SMALL_DOT} {OPTION_BIG_DOT} CHALLENGES");
static const u8 sText_TopBar_Right[]        = _("{L_BUTTON}{R_BUTTON} PAGE");
static void DrawTopBarText(void)
{
    ...
    {
        case MENU_RANDOMIZER:
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 8, 1, color, 0, sText_TopBar_Randomizer);
            break;
        case MENU_DIFFICULTY:
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 8, 1, color, 0, sText_TopBar_Difficulty);
            break;
        case MENU_CHALLENGES:
            AddTextPrinterParameterized3(WIN_TOPBAR, FONT_SMALL, 8, 1, color, 0, sText_TopBar_Challenges);
            break;
    }
...
void CB2_InitTxRandomizerChallengesMenu(void)
{
    ...
    case 6:
        ...
        gSaveBlock1Ptr->tx_Random_PkmnTiers                   = TX_RANDOM_SIMILAR;
        ...
        sOptions->sel_randomizer[MENUITEM_RANDOM_POKEMON_TIERS]              = !gSaveBlock1Ptr->tx_Random_PkmnTiers;
        ...
        if (gSaveBlock1Ptr->tx_Challenges_Nuzlocke && gSaveBlock1Ptr->tx_Challenges_NuzlockeHardcore)
            sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE] = 2;
        else if (gSaveBlock1Ptr->tx_Challenges_Nuzlocke)
            sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE] = 1;
        else
            sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE] = 0;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE]   = !gSaveBlock1Ptr->tx_Nuzlocke_SpeciesClause;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE]     = !gSaveBlock1Ptr->tx_Nuzlocke_ShinyClause;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING]       = !gSaveBlock1Ptr->tx_Nuzlocke_Nicknaming;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_DELETION]         = gSaveBlock1Ptr->tx_Nuzlocke_Deletion;        
        // MENU_DIFFICULTY
...
void SaveData_TxRandomizerAndChallenges(void)
{
    ...
    gSaveBlock1Ptr->tx_Random_PkmnTiers            = !sOptions->sel_randomizer[MENUITEM_RANDOM_POKEMON_TIERS];
    gSaveBlock1Ptr->tx_Random_MapBased           = TX_RANDOM_MAP_BASED;
    ...
    //MENU_NUZLOCKE
    switch (sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE])
    {
    case 0:
    ...
    {
        gSaveBlock1Ptr->tx_Nuzlocke_SpeciesClause   = !sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE];
        gSaveBlock1Ptr->tx_Nuzlocke_ShinyClause     = !sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE];
        gSaveBlock1Ptr->tx_Nuzlocke_Nicknaming      = !sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING];
        gSaveBlock1Ptr->tx_Nuzlocke_Deletion        = sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_DELETION];
    }
    else
    {
...
static void DrawChoices_Random_EvoStages(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_RANDOM_POKEMON_TIERS);
    u8 styles[2] = {0};
    styles[selection] = 1;
...
static void DrawChoices_Random_OffChaos(int selection, int y)
{
    ...
    if (selection == 1)
        sOptions->sel_randomizer[MENUITEM_RANDOM_POKEMON_TIERS] = 1;
}
...
static void DrawChoices_Challenges_Nuzlocke(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CHALLENGES_NUZLOCKE_NUZLOCKE);
    u8 styles[3] = {0};
    ...
    if (selection == 0)
    {
        sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE]   = !TX_NUZLOCKE_SPECIES_CLAUSE;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE]     = !TX_NUZLOCKE_SHINY_CLAUSE; 
        sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING]       = !TX_NUZLOCKE_NICKNAMING;
        sOptions->sel_challenges[MENUITEM_CHALLENGES_NUZLOCKE_DELETION]         = TX_NUZLOCKE_DELETION; 
    }
}

static void DrawChoices_Nuzlocke_SpeciesClause(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CHALLENGES_NUZLOCKE_SPECIES_CLAUSE);
    DrawChoices_Nuzlocke_OnOff(selection, y, active);
}
static void DrawChoices_Nuzlocke_ShinyClause(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CHALLENGES_NUZLOCKE_SHINY_CLAUSE);
    DrawChoices_Nuzlocke_OnOff(selection, y, active);
}
static void DrawChoices_Nuzlocke_Nicknaming(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CHALLENGES_NUZLOCKE_NICKNAMING);
    DrawChoices_Nuzlocke_OnOff(selection, y, active);
}
...
static void DrawChoices_Nuzlocke_Deletion(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CHALLENGES_NUZLOCKE_DELETION);
    u8 styles[2] = {0};
    styles[selection] = 1;
