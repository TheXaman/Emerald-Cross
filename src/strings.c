...
const u8 gText_SummaryShiny[] = _("S");
const u8 gText_SummaryPokerus[] = _("I");
const u8 gText_FatefulTriangle[] = _("F");
...
const u8 gText_SummaryNatureUp[] = _("UP");
const u8 gText_SummaryNatureDown[] = _("DOWN");
