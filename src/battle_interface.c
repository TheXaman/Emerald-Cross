...
bool32 CanThrowLastUsedBall(void)
{
    return (!(IsPlayerPartyAndPokemonStorageFull()
	 || InBattlePyramid()
     || (IsNuzlockeActive() && NuzlockeIsSpeciesClauseActive == 2)
     || (IsNuzlockeActive() && NuzlockeIsCaptureBlocked)
     || (gSaveBlock1Ptr->tx_Challenges_OneTypeChallenge && OneTypeChallengeCaptureBlocked)
     || (IsNuzlockeActive() && NuzlockeIsSpeciesClauseActive)
