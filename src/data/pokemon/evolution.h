const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GRAVELER]   = {{EVO_TRADE, 0, SPECIES_GOLEM, 0},
                            {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GOLEM, 0}},
    ...
    [SPECIES_SLOWPOKE]   = {{EVO_LEVEL, 37, SPECIES_SLOWBRO, 0},
                            ...
                            {EVO_STONE_HELD, ITEM_LINKING_CORD, SPECIES_SLOWKING, ITEM_KINGS_ROCK}},
    ...
    [SPECIES_HAUNTER]    = {{EVO_TRADE, 0, SPECIES_GENGAR, 0},
                            {EVO_ITEM, ITEM_LINKING_CORD, SPECIES_GENGAR, 0}},
    [SPECIES_ONIX]       = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_STEELIX, 0},
                            {EVO_STONE_HELD, ITEM_LINKING_CORD, SPECIES_STEELIX, ITEM_METAL_COAT}},
    ...
    [SPECIES_SEADRA]     = {{EVO_TRADE_ITEM, ITEM_DRAGON_SCALE, SPECIES_KINGDRA, 0},
                            {EVO_STONE_HELD, ITEM_LINKING_CORD, SPECIES_KINGDRA, ITEM_DRAGON_SCALE}},
    ...
    [SPECIES_SCYTHER]    = {{EVO_TRADE_ITEM, ITEM_METAL_COAT, SPECIES_SCIZOR, 0},
                            {EVO_STONE_HELD, ITEM_LINKING_CORD, SPECIES_SCIZOR, ITEM_METAL_COAT}},
    ...
    [SPECIES_PORYGON]    = {{EVO_TRADE_ITEM, ITEM_UP_GRADE, SPECIES_PORYGON2, 0},
                            {EVO_STONE_HELD, ITEM_LINKING_CORD, SPECIES_PORYGON2, ITEM_UP_GRADE}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_TRADE_ITEM, ITEM_DEEP_SEA_TOOTH, SPECIES_HUNTAIL, 0},
                            ...
                            {EVO_STONE_HELD, ITEM_LINKING_CORD, SPECIES_HUNTAIL, ITEM_DEEP_SEA_TOOTH},
                            {EVO_STONE_HELD, ITEM_LINKING_CORD, SPECIES_GOREBYSS, ITEM_DEEP_SEA_SCALE}},
